...
import type { BaseArticle, ArticlePageData, Locale } from "@/types/article";
import { ArrowLeft, ExternalLink, Github, Languages, Tag } from "lucide-react";
...
export function Article<T extends BaseArticle = BaseArticle>({
  ...
  return (
    ...
    >
      ...
      <article className="bg-background/50 border-border my-4 flex flex-2 flex-col rounded-2xl border px-4 py-10 lg:grid lg:grid-cols-[1fr_300px] lg:gap-8 lg:px-8">
        {/* Main content area */}
