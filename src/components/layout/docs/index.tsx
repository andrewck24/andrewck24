...
import { type Option, RootToggle } from "@/components/root-toggle";
            ...
            {links
              ...
              .map((item, i) => (
                <NavbarLinkItem
                  key={i}
                  item={item}
                  className="text-fd-muted-foreground hover:text-fd-accent-foreground data-[active=true]:text-fd-primary transition-variants text-sm"
                />
              ))}
          </div>
          {nav.children}
