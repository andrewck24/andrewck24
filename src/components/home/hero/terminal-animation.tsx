...
> AT runtime, where our ideas execute`;
  ...
  return (
    <div
      ...
      className="border-border from-gradient-5/20 via-gradient-3/20 to-gradient-2/20 grid min-h-[300px] w-full overflow-hidden rounded-lg border bg-gradient-to-r p-2 shadow-lg backdrop-blur-md lg:h-full lg:p-4"
    >
      <DynamicCodeBlock
        lang="bash"
        code={terminalCode}
